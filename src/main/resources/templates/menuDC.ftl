...
<nav
        class="navbar fixed-top navbar-expand-lg navbar-light black scrolling-navbar"
>
    <div class="container-fluid" style="justify-content: space-between;">
        <a href="/" class="navbar-brand waves-effect cl">
            <strong
                    style="color: blue; font-size:150%; font-family: 'American';"
            >DC Universe</strong
            >
        </a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarContent">
            ...
            <ul class="navbar-nav nav-flex-icons">
                ...
                <#if nameUser=="Вход/Регистрация">
                    <li class="nav-item ">
                        <a href="/login" class="btn btn-blue" style="color: black">
                            ${nameUser}
                        </a>
                    </li>
                <#else>
                    <li class="nav-item ">
                        <a href="/profile/${nameUser}" class="btn btn-blue" style="color: black">
                            Мой профиль
                        </a>
                    </li>
                    <li class="nav-item ">
                        <form method="post" action="/logout">
                            <input class="btn btn-blue" type="submit"  value="Выход" style="color: black">
...
<div class="container-fluid mx-0 px-0" style="margin-top: 5em">
    <main class="text-center mt-5 pt-4">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark black mt-3 mb-0">
                ...
                <div class="collapse navbar-collapse" id="nextNav">
                    ...
                    <form class="form-inline" method="get" action="/menu/DC/search">
            ...
            <div class="collapse" id="collapseExample">
                <div class="container border border-black" style="text-align: left">
                    <form method="get" action="/menu/DC/filter">
                        ...
                        <input type="hidden" name="Издательство" value="DC">
...
<footer class="page-footer text-center font-small mt-4 wow fadeIn black">
    <div class = "pt-4 pb-4">
        <a href="#">
