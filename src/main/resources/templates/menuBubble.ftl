            ...
            <ul class="navbar-nav nav-flex-icons">
                <li class="nav-item d-flex align-items-center">
                    <a href="#" class="nav-link waves-effect">
                        <span class="badge black z-depth-1 mr-1">2</span>
...
<div class="container-fluid mx-0 px-0" style="margin-top: 5em">
    <main class="text-center mt-5 pt-4">
        ...
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-dark blue mt-3 mb-0">
                ...
                <div class="collapse navbar-collapse" id="nextNav">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item active">
                            <a href="#" class="nav-link">Bubble</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <form class="form-inline" method="get" action="/menu/Bubble/search">
            ...
            <div class="collapse" id="collapseExample">
                <div class="container border border-black" style="text-align: left">
                    <form method="get" action="/menu/Bubble/filter">
                        ...
                        <input type="hidden" name="Издательство" value="Bubble">
...
<footer class="page-footer text-center font-small mt-4 wow fadeIn blue">
    <div class = "pt-4 pb-4">
        <a href="#">
